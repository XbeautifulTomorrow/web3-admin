  ...
  <div class="page-wrapper">
    <div class="public-list-inputs">
      ...
      <el-select v-model="source" class="public-select-box" popper-class="public-select-box" placeholder="全部来源" clearable>
        ...
        <el-option label="转入" value="TRANSFER">
        </el-option>
      </el-select>
      <el-select v-model="currentStatus" class="public-select-box" popper-class="public-select-box" placeholder="全部状态"
        clearable>
        <el-option label="待命" value="STANDBY">
        </el-option>
        <el-option label="一元购" value="ONE_YUAN_PURCHASE">
        </el-option>
      </el-select>
      ...
      <el-button type="primary" icon="el-icon-search" class="public-search" @click="fetchUserNftList()">
        查询
      </el-button>
    </div>
