  ...
  <div class="page-wrapper">
    ...
    <el-dialog :title="title" :visible.sync="showReviewDialog" width="600px" :close-on-click-modal="false"
      ...
      <div class="review-box">
        ...
        <div class="review-chain" v-if="reviewData &&
        ...
        <div class="review-remarks" v-if="reviewData &&
          reviewData.auditStatus != 'WAIT' &&
        ...
        <div class="review-submit" v-if="reviewData && reviewData.auditStatus == 'WAIT'">
          ...
          <div class="btn-box">
            ...
            <el-button type="primary" style="width: 160px" size="medium"
              @click="submitReview(1, reviewData)">通过</el-button>
          </div>
        </div>
      </div>
    </el-dialog>
